...
--> statement-breakpoint
ALTER TABLE "customer_service_conversation_events" ADD COLUMN "event_type" text DEFAULT 'customer_message' NOT NULL;--> statement-breakpoint
ALTER TABLE "customer_service_conversation_events" ADD COLUMN "body_hash" text;--> statement-breakpoint
ALTER TABLE "customer_service_conversation_events" ADD COLUMN "redaction_codes" jsonb DEFAULT '[]'::jsonb NOT NULL;--> statement-breakpoint
ALTER TABLE "customer_service_conversation_events" ADD COLUMN "reply_to_external_message_key_hash" text;--> statement-breakpoint
ALTER TABLE "customer_service_conversation_events" ADD COLUMN "learning_eligible" boolean DEFAULT false NOT NULL;--> statement-breakpoint
UPDATE "customer_service_conversation_events" SET "event_type" = 'human_outbound' WHERE "role" = 'staff';--> statement-breakpoint
ALTER TABLE "customer_service_conversation_events" ADD CONSTRAINT "customer_service_conversation_events_id_conversation_unique" UNIQUE("id","conversation_id");--> statement-breakpoint
...
ALTER TABLE "customer_service_conversation_events" ADD CONSTRAINT "customer_service_conversation_events_type_valid" CHECK ("customer_service_conversation_events"."event_type" in ('customer_message', 'human_outbound', 'system_event'));--> statement-breakpoint
ALTER TABLE "customer_service_conversation_events" ADD CONSTRAINT "customer_service_conversation_events_role_type_valid" CHECK (("customer_service_conversation_events"."role" = 'customer' and "customer_service_conversation_events"."event_type" = 'customer_message') or ("customer_service_conversation_events"."role" = 'staff' and "customer_service_conversation_events"."event_type" in ('human_outbound', 'system_event')));
