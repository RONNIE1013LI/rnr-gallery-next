...
ALTER TABLE "customer_service_image_analysis_inputs" ADD CONSTRAINT "customer_service_image_analysis_inputs_analysis_attempt_id_customer_service_image_analysis_attempts_id_fk" FOREIGN KEY ("analysis_attempt_id") REFERENCES "public"."customer_service_image_analysis_attempts"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "customer_service_image_analysis_inputs" ADD CONSTRAINT "customer_service_image_analysis_inputs_attachment_id_customer_service_attachments_id_fk" FOREIGN KEY ("attachment_id") REFERENCES "public"."customer_service_attachments"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
