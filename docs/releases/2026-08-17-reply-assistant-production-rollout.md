...
- [ ] Migration ID: `0030_reply_assistant_production`
...
- [ ] Apply `0030_reply_assistant_production` once through the approved migration process.
- [ ] Confirm all ten new tables and indexes exist.
