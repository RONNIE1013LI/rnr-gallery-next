...
type Dependencies = Readonly<{
  ...
  resendVerification: RecipientRuntime["resendVerification"];
...
export function createAdminNotificationRecipientVerificationRoute(
  ...
  return Object.freeze({
    async POST(request: Request, context: Context) {
      try {
        ...
        const result = await deps.resendVerification(actor(access), {
          ...body,
          recipientId,
        });
...
const route = createAdminNotificationRecipientVerificationRoute();
