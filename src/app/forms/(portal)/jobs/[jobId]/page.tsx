...
import { ExistingProductionJobForm } from "@/components/forms/existing-production-job-form";
...
export default async function FormsJobDetailPage({ params }: Props) {
  ...
  const [detail, assignees, proofing] = await Promise.all([
  ...
  return (
    <section className={`${styles.formsPage} ${styles.orderEditorPage}`}>
