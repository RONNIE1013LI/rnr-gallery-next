...
export default async function AdminSettingsPage() {
  ...
  return <section className={`${styles.pageSection} ${styles.narrowPage}`}>
    ...
    <div className={styles.settingsGrid}><Link className={styles.settingsLink} href="/admin/settings/shipping"><span>Shipping</span><strong>Quotes, destinations and pickup readiness</strong></Link><Link className={styles.settingsLink} href="/admin/settings/payment"><span>Payment</span><strong>Card, Afterpay and Zip readiness</strong></Link></div>
  </section>;
}
