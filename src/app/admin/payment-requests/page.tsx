...
export default async function AdminPaymentRequestsPage() {
  ...
  return <section className={styles.pageSection}>
    ...
    {requests.length ? <div className={styles.tableScroll}><table className={styles.dataTable}><thead><tr><th>Request</th><th>Type</th><th>Description</th><th>Amount</th><th>Status</th><th>Created by</th><th>Created</th><th /></tr></thead><tbody>{requests.map((request) => <tr key={request.id}>
      ...
      <td>{request.createdByName ?? "Unknown staff"}</td>
