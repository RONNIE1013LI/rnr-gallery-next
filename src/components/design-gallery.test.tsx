    ...
    render(<DesignGallery
      ...
      result={{
        items: [{
          ...
          width: 1200,
          height: 1600,
          publicSlug: "21st-birthday-aaaaaaaa",
          displayTitle: "21st Birthday",
          seoTitle: "21st Birthday Canvas Design",
          seoDescription: "Golden 21st birthday canvas design.",
          intro: "A 21st birthday canvas design.",
          secondaryOccasions: [],
          palette: [],
          seoIndex: true,
        ...
        items: [
          {
            ...
            width: 1200,
            height: 1600,
            publicSlug: "family-portrait-cccccccc",
            displayTitle: "Family Portrait",
            seoTitle: "Family Portrait Canvas Design",
            seoDescription: "Family portrait canvas design.",
            intro: "A family portrait canvas design.",
            secondaryOccasions: [],
            palette: [],
            seoIndex: true,
            hiddenFromListings: false,
          ...
          },
          {
            ...
            width: 2000,
            height: 1000,
            publicSlug: "80th-birthday-eeeeeeee",
            displayTitle: "80th Birthday",
            seoTitle: "80th Birthday Wall Banner Design",
            seoDescription: "80th birthday wall banner design.",
            intro: "An 80th birthday wall banner design.",
            secondaryOccasions: [],
            palette: [],
            seoIndex: true,
            hiddenFromListings: false,
