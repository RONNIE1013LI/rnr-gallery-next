...
const storefrontContentDefinitions = Object.freeze([
  ...
  { key: "delivery.production_time", group: "Delivery & production", label: "Production time", description: "Default production-time statement.", maxLength: 500, multiline: true, defaultValue: "All orders have a production time of 3 business days from the date the order is placed." },
  ...
  { key: "delivery.au_time", group: "Delivery & production", label: "AU delivery time", description: "Estimated AU delivery after production.", maxLength: 240, multiline: true, defaultValue: "Australia: DHL Express is around 2 days to major east-coast cities; Standard is around 7–10 days. Remote areas may take around two weeks. Times exclude production." },
