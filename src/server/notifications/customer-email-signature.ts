...
export function renderCustomerEmailSignature(
  ...
  const html = [
    ...
    '<tbody><tr>',
    '<td width="84" style="width:84px;min-width:84px;padding:0 12px 0 0;vertical-align:top">',
    `<img src="${escapeHtml(logoUrl)}" alt="R&amp;R Gallery" width="72" height="72" style="display:block;width:72px;max-width:72px;height:72px;margin:0;border-radius:50%;object-fit:cover">`,
    '</td>',
