...
export function reasoningContext(request: RnrAiRequest) {
    ...
    return { websiteMarket: request.channel === 'website' && request.market !== 'UNKNOWN' ? request.market : null, pageContext: request.pageContext ?? null, turns, activeCustomerTurn: turns.at(-1), resolvedThrough: resolvedIndex >= 0 ? turns[resolvedIndex].id : null,
