...
describe("website analytics v2 business rules", () => {
  it.each([
    ...
    [{ source: "manual", manualFinalizationCommitted: true, amountPayableCents: 12500, initialStatus: "confirmed" }, true],
    [{ source: "manual", manualFinalizationCommitted: false, amountPayableCents: 12500, initialStatus: "confirmed" }, false],
