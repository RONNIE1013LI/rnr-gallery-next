...
const manualJobSchema = z.object({
  ...
  trackingCarrier: z.string().trim().max(190).nullable().default(null),
  trackingNumber: z.string().trim().max(190).nullable().default(null),
  trackingUrl: z.string().trim().max(2_000).nullable().default(null),
...
const jobUpdateSchema = z.object({
  ...
  trackingCarrier: z.string().trim().max(190).nullable().optional(),
  trackingNumber: z.string().trim().max(190).nullable().optional(),
  trackingUrl: z.string().trim().max(2_000).nullable().optional(),
